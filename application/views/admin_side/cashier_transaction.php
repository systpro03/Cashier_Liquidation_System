...
<body class="corporate">
    ...
    <?php
      $this->load->view('admin_side/header');
      $this->load->view('admin_side/admin_js');
    ?>
            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">cashier transaction table</span>
                        </div>              
                    </div>
                    <form class="form-inline">
                      <center>
                        <label style="font-weight: bold; font-size: 15px;">BUSINESS UNIT:</label>
                        <select class="form-control input-sm data" onchange="get_dept_name_js()" id="bunit_name" style="height: 35px; width: 20%; font-size: 15px;"></select>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <label style="font-weight: bold; font-size: 15px;">DEPARTMENT:</label>
                        <select class="form-control input-sm data" onchange="get_cashier_transaction_js()" id="dept_name" style="height: 35px; width: 20%; font-size: 15px;"></select>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <label style="font-weight: bold">FILTER DATE:</label>
                        <input type="date" class="form-control" onchange="get_cashier_transaction_js()" style="height: 35px;" id="filter_date" value="<?php echo date('Y-m-d'); ?>">
                      </center>
                    </form><br><br>
                    <div class="portlet-body" id="div_cashier_transaction_table">
                       <!-- ==========transferred denomination table list==================== -->
                    </div> 
                </div>  
            </div>  
        </div>    
