            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="">
                            <a href="<?php echo base_url('accounting_side_about') ?>">About Us</a>
                        </li>
                    </ul>
                </div>
                ...
                ?>
                        ...
                        <!-- <li>
                            <a class="btn btn-sm" href="<?php echo base_url('assets/guide/Accounting User Guide.pdf'); ?>" style="background-color: rgb(110, 110, 110); color: white" target="_blank">USER GUIDE</a>
                        </li> -->
                        <li class="">
                          ...
                          <div class="modal-dialog modal-lg" style="width: 70%">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <iframe src="<?php echo base_url('assets/guide/Accounting User Guide.pdf'); ?>" width="100%" height="600"></iframe>
                              </div>
