                ...
                <div class="portlet light">
                    ...
                    <form class="form-inline">
                      <center>
                          ...
                          <input type="date" id="input_sales_date" max="<?php echo date('Y-m-d') ?>" onchange="display_sales_date_uploaded_js_v2()" style="border: groove; height: 33px;" value="<?php echo date('Y-m-d') ?>">
                          ...
                          <button type="button" class="btn btn-primary" onclick="print_unadjusted_navcls_js_all()" id="view_all">🖨️ PRINT ALL</button>
                          <br><br>
