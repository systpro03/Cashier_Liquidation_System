        ...
        <div class="container">
            <div class="row">
                ...
                ?>
                        ...
                        <li><a href="<?php echo base_url() ?>login_route">Log Out</a></li>
                    </ul>
                </div>
                <!-- END TOP BAR MENU -->
            </div>
      ...
      <div class="container">
        ...
        else
        {
          ?>
              ...
              <ul>
                <li>
                  <a href="<?php echo base_url() ?>cfscashier_denomination_route">
                  Cash/Noncash Denomination Form             
                  </a>
                </li> 
                <li>
                  <a href="<?php echo base_url() ?>cfs_forex_denomination_route">
                  Forex Denomination Form        
                  </a>
                </li> 
                <li>
                  <a href="<?php echo base_url() ?>cfs_history_denomination_route">
                  History Form        
                  </a>
                </li> 
              </ul>
