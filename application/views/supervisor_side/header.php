            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="">
                            <a href="<?php echo base_url('supervisor_side_about') ?>">About Us</a>
                        </li>
                    </ul>
                </div>
                ...
                ?>
                        ...
                        <!-- <li class="">
                          <a class="btn btn-sm" href="<?php echo base_url('assets/guide/Liquidation Supervisor User Guide.pdf'); ?>" style="background-color: rgb(110, 110, 110); color: white" target="_blank">USER GUIDE</a>
                      </li> -->
                      <li class="">
                        ...
                        <div class="modal-dialog modal-lg" style="width: 70%">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <iframe src="<?php echo base_url('assets/guide/Liquidation Supervisor User Guide.pdf'); ?>" width="100%" height="600"></iframe>
                            </div>
        ...
        else
        {
          ?>
              ...
              <ul>
                ...
                <li class="" id="cashier_access">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                      <a href="<?php echo base_url() ?>supervisor_cashier_violation_route">Violation</a>
                ...
                <li class="" id="add_payment_header">
                  <a href="<?php echo base_url() ?>supervisor_add_payment_route_v2">
                    MODE OF PAYMENT      
                  </a>
                </li> 
                <!-- <li class="" id="demo_id">
