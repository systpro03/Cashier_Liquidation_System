            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light dialog">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">filter month and year for cashier productivity report</span>
                        </div>              
                    </div>
    ...
    <div class="portlet-body row" id="divbody_cashier_counter">
                    ...
                    <form class="form-inline">
                      <center>
                        ...
                        <!-- ============================================================================================================================================== -->
                        <label style="font-weight: bold; font-size: 15px;">TYPE:</label>
                        <select class="input-sm" style="height: 35px;" id="report_type">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <button type="button" id="print_btn" class="btn waves-effect" style="background-color: maroon; color: white;" onclick="print_all_cashier_productivivty_js()">PRINT 🖨️</button>
                      </center>
                    </form>
                    </div> 
                </div>  
